...
import BackGroundImage from '../assets/BG_Main.png';
...
const SelectModePage = () => {
    ...
    const hundlemakecuisine_css = "w-3/5 m-6 border-2 border-Fuchsia-500 bg-retro-bordeaux py-2 hover:bg-gray-700 transition duration-300 focus:border-transparent"
    const hundleselectcuisine_css = "w-3/5 m-6 border-2 border-Fuchsia-500 bg-retro-bordeaux py-2 hover:bg-gray-700 transition duration-300 focus:border-transparent"
    const hundleselectcuisine_null_css = "w-3/5 m-6 border-0 border-Fuchsia-500 bg-creamy-emerald bg-opacity-40 text-opacity-50 py-2 transition duration-300"
